...
if uploader is not None:
    ...
    selections =['Select Image Which want to ','Voilance & Non Voilance', 'Birds', 'Weather Image', 'Chiken Pox']

    selection = st.selectbox('Select Image App', selections)
